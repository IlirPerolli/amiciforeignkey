...
<div class = "footer">
<span class='amici' style = "font-size: 20px;"> amici</span><span class = "team" style = " border-right: 2px solid black; margin-right;font-size: 20px;"> team <span style = "color:black;font-size: 20px;">&#9400; 2020 </span></span><span class='amici' id = "amici1" style = "font-size: 20px;">Gjakova</span>
</div>
 <div class = "amici1"> <span class='amici' style = "font-size:15px"> amici</span><span class = "team" style = "font-size:15px;  border-right: 2px solid black; margin-right"> team <span style = "color:black;">&#9400; 2020 </span></span><span class='amici' id = "amici1" style = "font-size:15px;">Gjakova</span></div>
