...
//Fshij fotot e ngarkuara ne grup
 ...
 if (mysqli_num_rows($results) == 0) {
            ...
            $sql = "UPDATE users set verification = '2' where id = '$number'";
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <a class="nav-link" href="files.php" style = "font-family: 'SamsungSharpSans-Bold'; font-size:20px;">Dosjet  <span id = "notification-counter-uploads"> <?php echo $_SESSION['notification_uploads'] ?> </span> <span class="sr-only">(current)</span></a>
       ...
       <a class="nav-link active" href="users.php" style = "font-family: 'SamsungSharpSans-Bold'; font-size:20px;">Perdoruesit <span class="sr-only">(current)</span></a>
    </ul>
    <?php
 ...
 echo '<style>#postimet { display:none !important;}</style>'; 
    ...
    while(($row = $query->fetch_assoc()) !== null){
       echo '<style>#postimet { display:none !important;}</style>'; 
                        ...
                        echo '<div class = "verifikim-i-aprovuar" style = "background:#ffc107;" >';
                  echo '<a href = "users.php?suspend='. $row['id'].'" style = "color:black">Suspendo </a>';
                       echo '</div>';
                        echo '<div class = "verifikim-i-refuzuar" >';
                  echo '<a href = "users.php?refuse='. $row['id'].'">Fshij </a>';
                       echo '</div>';
                       echo'</div>';
                         echo '</div>';
...
echo'<div class = "postimet-title">';
echo'  Anetaret e pa verifikuar';
echo '</div>';
...
echo'<br>'; 
                  ...
                  echo '<a href = "users.php?user='. $row['id'].'">Aprovo </a>';
                       echo '</div>';
                        echo '<div class = "verifikim-i-refuzuar" >';
                  echo '<a href = "users.php?refuse='. $row['id'].'">Refuzo </a>';
                       echo '</div>';
                       echo'</div>';
                         echo '</div>';
