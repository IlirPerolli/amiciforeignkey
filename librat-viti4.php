<?php
    ...
    if (!isset($_SESSION['vitiakademik']) || $_SESSION['vitiakademik'] == "3") {
        header("Location: index.php");
    }
?>
<html>
<head>
  <title> Librat - VITI 1 - MASTER </title>
...
<?php 
$querycheck = "SELECT * FROM books WHERE academicyear=4 order by id asc ";
