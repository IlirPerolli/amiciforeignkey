...
echo $number_of_results = mysqli_num_rows($results3);
...
<img src = "img/people_online.png" width="40px"/>  
</button>
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    $results = mysqli_query($db, $query);
    echo '<span style = "color:green; font-size:20px" >Online ('.mysqli_num_rows($results).")".'</span>
        <br><br>';
       while(($row = $results->fetch_assoc()) !== null){   
echo '
  <li class="media">
...
<!-- OFFLINE -->
    ...
    $results = mysqli_query($db, $query);
    echo '<span style = "color:grey; font-size:20px">Offline ('.mysqli_num_rows($results).")".'</span>
        <br><br>';
          while(($row = $results->fetch_assoc()) !== null){   
echo '
  <li class="media">
