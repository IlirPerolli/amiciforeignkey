...
<form method="POST" enctype="multipart/form-data" action="upload-files.php" class = "forma-bootstrap">
...
<form method="POST" enctype="multipart/form-data" action="upload-files.php" class = "forma-default">
