<?php
  ...
  include("check-vitiakademik.php");
   ...
   else if (!isset($_SESSION['vitiakademik']) || $_SESSION['vitiakademik'] == "2") {
        header("Location: index.php");
    }
        // lidhu me databaze
include("config.php");
...
<div class = "container">
<br>
<form method="POST" enctype="multipart/form-data" action="upload-files2.php" class = "forma-bootstrap">
...
<form method="POST" enctype="multipart/form-data" action="upload-files2.php" class = "forma-default">
